    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="juegos/juegos.html">Juegos</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="clientes/cliente.html">Clientes</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="categoria/categoria.html">Categoria</a>
                </li>
                ...
                Consultas
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="consultas/total_cliente.html">Consultas</a>
